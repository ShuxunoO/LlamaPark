...
def initialize_chat(NFT_ID):
    ...
    llama_des = llama_description.get(NFT_ID, "You're a llama from Llama Park")
    messages = {
            "role": "system",
